...
Future<void> _deleteBooking(String bookingId) async {
  try {
    ...
    final roomNumberToRemove = bookingData['roomNumber'] as int; // Ensure roomNumber is an int
    final roomTypeId = bookingData['roomId'] as String; // Ensure correct type for roomType ID
    ...
    await firestore.runTransaction((transaction) async {
      ...
      final bookedRrooms = List<dynamic>.from(roomTypeDoc.data()?['bookedRrooms'] ?? []);
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Booking deleted and room updated successfully')),
    );
  } catch (e) {
            ...
            builder: (context, futureSnapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  print('Booking Id: $bookingId, Hostel Name: $hostelName');
